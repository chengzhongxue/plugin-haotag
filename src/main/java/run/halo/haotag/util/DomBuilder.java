...
public class DomBuilder {
    ...
    private static final String ABSOLUTE_PATH = "/plugins/HaoTag/assets/static";
    private static final String SCRIPT_HEAD =
            "<script src=\"" + ABSOLUTE_PATH;
    private static final String THEME_SCRIPT_HEAD =
            "<script src=\"";
    ...
    // 构建script
    public DomBuilder themeScript(String path) {
        // 直接形成scripts标签
        DOM_LIST.add(THEME_SCRIPT_HEAD + handlePath(path) + "\"" + SCRIPT_END);
        return this;
    }
